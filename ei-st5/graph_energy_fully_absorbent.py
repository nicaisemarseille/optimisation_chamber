...
if __name__ == '__main__':
    ...
    chi = numpy.ones((M, N), dtype=numpy.float64)
    ...
    # travail à 1GHz, ce qui impose alpha
    omega = 2*numpy.pi * 1e9
    ...
    chi0 = chi.copy()
    u0 = u.copy()
    omega_min = 2 * numpy.pi * 1e6
    omega_max = 2 * numpy.pi * 1e10
    omegas = numpy.linspace(omega_min, omega_max, num=200)  # échelle logarithmique pour oméga
    ...
    for omega in omegas:
        ...
        objective_value = your_compute_objective_function(domain_omega, u, spacestep)
        objective_values.append(objective_value)

    # Tracé des résultats
    matplotlib.pyplot.figure(figsize=(10, 6))
    matplotlib.pyplot.plot(omegas, objective_values, label="Objective Function")
    ...
    print(your_compute_objective_function(domain_omega,u0,spacestep))
    print('End.')
